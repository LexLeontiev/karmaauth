...
public class DocumentCropImageView extends AppCompatImageView {
    ...
    public DocumentCropImageView(Context context) {
        super(context);
        init(null, 0);
    }

    public DocumentCropImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public DocumentCropImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_MOVE: {
                ...
                // Determine if the point will still be in area of image
//                if (eventPoint.x >= getWidth() || eventPoint.x <= 0
//                        || eventPoint.y >= getHeight() || eventPoint.y <= 0) {
//                    mLastTouchedPoint.set(event.getX(), event.getY());
//                }
